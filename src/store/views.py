...
class SetCoverView(APIView):
    ...
    def post(self, request):
        ...
        if media:
            ...
            collection.save()
        remove_banner = request.data.get("remove_cover")
        if remove_banner in [True, "true"]:
            collection.cover_ipfs = None
            collection.save()
