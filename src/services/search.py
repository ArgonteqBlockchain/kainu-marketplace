...
class SearchToken(SearchABC):
    ...
    def order_by(self, order_by):
        ...
        # of ordering by price, filter only on sale if necessary
        if order_by == "price" and "on_any_sale" not in self.kwargs.keys():
            self.on_any_sale(None)
